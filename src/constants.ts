let _properties: GoogleAppsScript.Properties.Properties | undefined = undefined;
let _spreadsheet: GoogleAppsScript.Spreadsheet.Spreadsheet| undefined = undefined;
...
export namespace Constants {
  export class Meta {
    ...
    public get properties(): GoogleAppsScript.Properties.Properties {
      if (_properties) {
        return _properties;
      }
      return _properties = PropertiesService.getScriptProperties();
    }
    ...
    public get spreadsheet(): GoogleAppsScript.Spreadsheet.Spreadsheet {
      ...
      return _spreadsheet = SpreadsheetApp.getActiveSpreadsheet();
    }
  }

  export namespace Regex {
    export const jobName: RegExp = /^\d{4}\s\d{4}\s.*/;
    export const isproposalName: RegExp = /^PROPOSAL: \d{4}\s.*/;
    export const is4Digits: RegExp = /^\d{4}/;
